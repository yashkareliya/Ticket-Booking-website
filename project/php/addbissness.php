...
<head>
	...
	<title>Add bissness package</title>
	...
	<!-- header ends -->
		...
		<!--booking start-->
			...
			<section class="booking">
				...
				<h1 class="heading_title"> Add bissness package  !</h1>

					<form action="add2.php" method="post" class="book_from">
