...
<head>
	...
	<title>Add economic package</title>
	...
	<!-- header ends -->
		...
		<!--booking start-->
			...
			<section class="booking">
				...
				<h1 class="heading_title"> Add economic package  !</h1>

					<form action="add1.php" method="post" class="book_from">
